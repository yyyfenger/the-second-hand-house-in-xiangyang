...
# filename = "Analyze\\file\\ershoufang.csv"
filename = "C:\\Users\\bingo\\Desktop\\毕设\\test\\get\\Analyze\\file\\ershoufang-mini-utf8.csv"
with open(filename, encoding="utf-8") as f:
    reader = csv.reader(f)
    context = [line for line in reader]

with open("C:\\Users\\bingo\\Desktop\\毕设\\test\\get\\Analyze\\file\\ershoufang-mini-utf8.txt", "w", encoding="utf-8", newline="") as f:
    writer = csv.writer(f)
    for line in context:
